		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Picking freestyle with dynamic page",
									"targetURL": "#fiorifreestylepicking01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorifreestylepicking01-display": {
								"semanticObject": "fiorifreestylepicking01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorifreestylepicking01",
									"url": sap.ui.require.toUrl("fiorifreestylepicking01")
								}
							}
						}
					}
